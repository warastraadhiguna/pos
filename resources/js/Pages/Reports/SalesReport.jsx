...
export default function SalesReport({ start, end, outletId, report, outlets, multiBranchEnabled }) {
    ...
    // Multi-Cabang Lapisan 4 -- "" (kosong) = GABUNGAN semua cabang,
    // perilaku default identik sebelum Lapisan 4 ada.

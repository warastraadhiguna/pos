...
export default function CreateWithdrawal({ outlets, cashAccounts }) {
    ...
    const confirmSave = () => {
        ...
        post(route('modal.withdrawal.store'));
    };
        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-800">
                    Catat Pengambilan Pribadi (Prive)
                </h2>
            }
        >
                ...
                <div className="mx-auto max-w-2xl sm:px-6 lg:px-8">
                    <div className="bg-white p-4 shadow-sm sm:rounded-lg sm:p-8">
                        <p className="mb-6 text-sm text-gray-500">
                            Prive adalah pengambilan uang usaha untuk keperluan
                            pribadi pemilik — pengurang modal, BUKAN beban
                            usaha, sehingga tidak akan muncul di Laba Rugi.
                        </p>
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    <InputLabel htmlFor="cash_account_code" value="Diambil Dari" />
                                    <SelectInput
                            ...
                            <div>
                                ...
                                <TextInput
                                    ...
                                    placeholder='mis. "Keperluan pribadi"'
            ...
            <Modal show={showConfirm} onClose={() => setShowConfirm(false)} maxWidth="md">
                <div className="p-6">
                    <h3 className="text-lg font-medium text-gray-900">
                        Konfirmasi Pengambilan Pribadi
                    </h3>
                    ...
                    <p className="mt-4 text-sm text-gray-600">
                        Yakin ingin menyimpan pengambilan pribadi ini?
                    </p>

...
const icons = {
    ...
    produk: "M7 7h.01M7 3h5.586a1 1 0 01.707.293l6.414 6.414a1 1 0 010 1.414l-7.586 7.586a1 1 0 01-1.414 0L4.293 12.293A1 1 0 014 11.586V6a3 3 0 013-3z",
    ...
    neraca: "M8 17v-5m4 5V9m4 8v-3M5 21h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2z",
    ...
    cabang: "M3 21h18M5 21V10l7-6 7 6v11M9 21v-6h6v6",
    distribusi:
...
const navGroups = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                name: "Stock Opname",
                href: "stock-opname.index",
                match: "stock-opname.*",
                icon: icons.stockOpname,
                permission: "stock-opname.manage",
            },
            {
                name: "Distribusi Stok",
                href: "distribusi.stock-distributions.index",
                match: "distribusi.*",
                icon: icons.distribusi,
                permission: "distributions.manage",
                feature: "multi_branch_enabled",
            },
            {
                name: "Kas & Bank",
                icon: icons.neraca,
    ...
    },
    {
        ...
        items: [
            ...
            {
                name: "Member",
                href: "master.members.index",
                match: "master.members.*",
                icon: icons.pengguna,
                permission: "master-data.manage",
                feature: "member_enabled",
            },
            {
                name: "Meja",
                href: "master.tables.index",
                match: "master.tables.*",
                icon: icons.meja,
                permission: "master-data.manage",
                feature: "table_enabled",
            },
            {
                name: "Template Catatan",
                href: "master.note-templates.index",
                match: "master.note-templates.*",
                icon: icons.catatan,
                permission: "master-data.manage",
                feature: "note_enabled",
            },
            {
                name: "Ukuran",
                href: "master.uoms.index",
                match: "master.uoms.*",
                icon: icons.ukuran,
                permission: "master-data.manage",
            },
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                href: "laporan.perbandingan-cabang",
                match: "laporan.perbandingan-cabang",
                icon: icons.cabang,
                permission: "laporan.view",
                feature: "multi_branch_enabled",
            },
            {
                ...
                href: "laporan.laba-produk",
                match: "laporan.laba-produk",
                icon: icons.labaRugi,
                permission: "laporan.view",
            },
            {
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                match: "coa.*",
                icon: icons.neraca,
                permission: "coa.manage",
            },
            {
                name: "Cabang",
                href: "master.outlets.index",
                match: "master.outlets.*",
                icon: icons.cabang,
...
|--------------------------------------------------------------------------
|
| `onNavigate` digunakan khusus mobile.
| Desktop tidak mengirim callback ini sehingga perilakunya tetap sama.
|
*/
...
|--------------------------------------------------------------------------
|
| Parent seperti Penjualan, Pembelian, Kas & Bank, dll. TIDAK menutup
| mobile sidebar. Ia hanya membuka/menutup submenu.
|
*/
function SidebarParent({ item, onNavigate = null }) {
...
|
| min-h-0:
| Penting ketika nav berada di dalam flex container.
|
| overflow-y-auto:
| Membuat daftar menu bisa di-scroll vertikal.
|
| overscroll-contain:
| Mencegah scroll sidebar "bocor" ke halaman di belakangnya pada mobile.
|
*/
function SidebarNav({
    permissions,
    ...
    const visibleGroups = navGroups
        .map((group) => ({
            ...
            items: group.items
                .map((item) =>
                    filterVisibleItem(item, permissions, featureFlags),
                )
                .filter(Boolean),
        }))
                ...
                <div key={group.label ?? "top"}>
                    ...
                    <div className="space-y-1">
                        {group.items.map((item) => {
                            ...
                            // Collapsed mode has no room for a flyout submenu,
                            // sehingga children ditampilkan sebagai icon link.
                            if (collapsed) {
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            {showingMobileNav && (
                <div className="fixed inset-0 z-40 lg:hidden">
                    ...
                    {/*
                        h-dvh:
                        mengikuti tinggi viewport HP yang sebenarnya.

                        overflow-hidden:
                        mencegah seluruh sidebar keluar viewport.

                        Navigation di dalamnya yang akan scroll.
                    */}
                    <aside className="relative flex h-dvh w-64 flex-col overflow-hidden bg-gray-900">
                        {/*
                            Header tidak ikut scroll.
                        */}
                        <div className="flex shrink-0 items-center justify-between gap-2 px-6 py-5">
                            <Link
                                href="/"
                                onClick={() => setShowingMobileNav(false)}
                        ...
                        {/*
                            ...
                            min-h-0 + flex-1 membuat container
                            hanya menggunakan sisa tinggi sidebar.

                            SidebarNav di dalamnya kemudian dapat
                            menggunakan overflow-y-auto.
                        */}
                        <div className="flex min-h-0 flex-1">
                            <SidebarNav
                                permissions={permissions}
                                featureFlags={featureFlags}
                                onNavigate={() => setShowingMobileNav(false)}
                            />
                        </div>
                    </aside>
                </div>
